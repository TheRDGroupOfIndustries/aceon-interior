        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              >
                <motion.h1
                  className="text-4xl md:text-5xl font-serif text-[#b98663]"
                  variants={itemVariants}
                >
                  {service.title}
                </motion.h1>
            ...
            <motion.hr
              variants={itemVariants}
              className="my-12 md:my-16 border-t border-neutral-200"
            />

            {/* --- Key Features Section --- */}
            {service.keyFeatures && (
              <motion.div variants={itemVariants}>
                <h2 className="text-3xl font-serif text-neutral-800 mb-6">
                  Key Features
                </h2>
            ...
            {service.process && (
              <motion.div variants={itemVariants}>
                <h2 className="text-3xl font-serif text-neutral-800 mb-8 text-center">
                  Our Process
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {service.process.map((step) => (
                    <div key={step.step} className="text-center p-4">
                      <div className="text-4xl font-serif font-bold text-[#b98663] mb-2">
                        {step.step}
                      </div>
