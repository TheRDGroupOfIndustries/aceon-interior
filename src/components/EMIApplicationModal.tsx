...
const EMIApplicationModal: React.FC<EMIApplicationModalProps> = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    if (formData.totalAmount && formData.emiTenure) {
      const principal = Number(formData.totalAmount) - Number(formData.downPayment || 0);
      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="bg-gradient-to-r from-[#A97C51] to-[#8b6e5b] text-white p-6 rounded-t-2xl">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-white/90 mt-1">Easy financing for your dream interior</p>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 bg-gray-50/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                >
                  <option value="" className="text-gray-500">Select Package</option>
                  <option value="Basic Interior" className="text-gray-900">Basic Interior</option>
                  <option value="Premium Interior" className="text-gray-900">Premium Interior</option>
                  <option value="Luxury Interior" className="text-gray-900">Luxury Interior</option>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#A97C51] focus:border-transparent transition-all duration-200 text-gray-900 appearance-none cursor-pointer"
                  >
                    <option value="" className="text-gray-500">Select Tenure</option>
                    <option value="3" className="text-gray-900">3 Months</option>
                    <option value="6" className="text-gray-900">6 Months</option>
                    <option value="9" className="text-gray-900">9 Months</option>
              ...
              {calculatedEMI > 0 && (
                <div className="bg-gradient-to-r from-[#F8F4F0] to-[#F0EBE5] p-4 rounded-lg border border-[#E5DED5]">
                  <p className="text-sm text-gray-600 font-medium">Estimated Monthly EMI</p>
                  <p className="text-2xl text-[#A97C51] font-bold">₹{calculatedEMI.toLocaleString()}</p>
                  <p className="text-xs text-gray-500 mt-1">
                    Based on {formData.emiTenure} months tenure with {formData.downPayment ? `₹${Number(formData.downPayment).toLocaleString()} down payment` : 'no down payment'}
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="salaried" className="text-gray-900">Salaried</option>
            ...
            <div className="space-y-4 bg-white p-4 rounded-lg border border-gray-200">
              <label className="flex items-start space-x-3 cursor-pointer group">
                ...
                <span className="text-sm text-gray-700 leading-relaxed">
                  I agree to the <span className="text-[#A97C51] font-medium">Terms & Conditions</span> and understand that this application is subject to approval based on creditworthiness and other factors.
                </span>
              </label>
              ...
              <label className="flex items-start space-x-3 cursor-pointer group">
                ...
                />
                <span className="text-sm text-gray-700 leading-relaxed">
                  I authorize Aceon Interio to perform credit checks and verify the information provided. I understand this is a standard procedure for EMI approval.
                </span>
              </label>
            </div>
          </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-end pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={isSubmitting || !formData.agreeTerms || !formData.agreeCreditCheck}
