...
const creationsData: CreationCardProps[] = [
  {
    ...
    description: 'Figma Ipsum Component Variant Main Layer. Opacity Slice Line Distribute Inspect Font. Scrolling Italic Move Move Inspect Connection.',
  },
  {
...
const CreationCard: React.FC<CreationCardProps> = ({ imageSrc, title, description }) => {
  return (
    <article className="w-full max-w-[373px] flex-shrink-0">
      <div className="h-[311px] overflow-hidden">
        <img 
          src={imageSrc} 
          alt={title} 
      ...
      <div className="mt-6 text-left">
        ...
        <p className="font-poppins text-gray-500 mt-2 text-base text-justify leading-relaxed">
          {description}
        </p>
        <div className="mt-6 text-right">
            <a href="#" className="font-poppins font-medium text-lg md:text-[20px] text-[#936a53] inline-block capitalize hover:text-[#7d5945] transition-colors">
              Read More →
            </a>
        </div>
      </div>
